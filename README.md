...
- Get [Support](https://app-generator.dev/ticket/create/?generated_repo=https://github.com/app-generator/django-material-kit-1749169825) via `eMail` and `Discord`
- Resources:
...
```bash
$ git clone https://github.com/django-material-kit-1749169825.git
$ cd django-material-kit-1749169825
```
